...
`)},ae={root:"p-accordion p-component"},te=g.extend({name:"accordion",theme:oe,classes:ae}),ce={name:"BaseAccordion",extends:b,props:{value:{type:[String,Number,Array],default:void 0},multiple:{type:Boolean,default:!1},lazy:{type:Boolean,default:!1},tabindex:{type:Number,default:0},selectOnFocus:{type:Boolean,default:!1},expandIcon:{type:String,default:void 0},collapseIcon:{type:String,default:void 0},activeIndex:{type:[Number,Array],default:null}},style:te,provide:function(){return{$pcAccordion:this,$parentInstance:this}}},re={name:"Accordion",extends:ce,inheritAttrs:!1,emits:["update:value","update:activeIndex","tab-open","tab-close","tab-click"],data:function(){return{id:this.$attrs.id,d_value:this.value}},watch:{"$attrs.id":function(n){this.id=n||T()},value:function(n){this.d_value=n},activeIndex:{immediate:!0,handler:function(n){this.hasAccordionTab&&(this.d_value=this.multiple?n==null?void 0:n.map(String):n==null?void 0:n.toString())}}},mounted:function(){this.id=this.id||T()},methods:{isItemActive:function(n){var o;return this.multiple?(o=this.d_value)===null||o===void 0?void 0:o.includes(n):this.d_value===n},updateValue:function(n){var o,t=this.isItemActive(n);this.multiple?t?this.d_value=this.d_value.filter(function(d){return d!==n}):this.d_value?this.d_value.push(n):this.d_value=[n]:this.d_value=t?null:n,this.$emit("update:value",this.d_value),this.$emit("update:activeIndex",this.multiple?(o=this.d_value)===null||o===void 0?void 0:o.map(Number):Number(this.d_value)),this.$emit(t?"tab-close":"tab-open",{originalEvent:void 0,index:Number(n)})},isAccordionTab:function(n){return n.type.name==="AccordionTab"},getTabProp:function(n,o){return n.props?n.props[o]:void 0},getKey:function(n,o){return this.getTabProp(n,"header")||o},getHeaderPT:function(n,o){var t=this;return{root:r({onClick:function(a){return t.onTabClick(a,o)}},this.getTabProp(n,"headerProps"),this.getTabPT(n,"header",o)),toggleicon:r(this.getTabProp(n,"headeractionprops"),this.getTabPT(n,"headeraction",o))}},getContentPT:function(n,o){return{root:r(this.getTabProp(n,"contentProps"),this.getTabPT(n,"toggleablecontent",o)),transition:this.getTabPT(n,"transition",o),content:this.getTabPT(n,"content",o)}},getTabPT:function(n,o,t){var d=this.tabs.length,a={props:n.props||{},parent:{instance:this,props:this.$props,state:this.$data},context:{index:t,count:d,first:t===0,last:t===d-1,active:this.isItemActive("".concat(t))}};return r(this.ptm("accordiontab.".concat(o),a),this.ptmo(this.getTabProp(n,"pt"),o,a))},onTabClick:function(n,o){this.$emit("tab-click",{originalEvent:n,index:o})}},computed:{tabs:function(){var n=this;return this.$slots.default().reduce(function(o,t){return n.isAccordionTab(t)?o.push(t):t.children&&t.children instanceof Array&&t.children.forEach(function(d){n.isAccordionTab(d)&&o.push(d)}),o},[])},hasAccordionTab:function(){return this.tabs.length}},components:{AccordionPanel:x,AccordionHeader:K,AccordionContent:w,ChevronUpIcon:I,ChevronRightIcon:j}};function ie(e,n,o,t,d,a){var A=P("AccordionHeader"),S=P("AccordionContent"),H=P("AccordionPanel");return i(),y("div",r({class:e.cx("root")},e.ptmi("root")),[a.hasAccordionTab?(i(!0),y(L,{key:0},z(a.tabs,function(c,l){return i(),s(H,{key:a.getKey(c,l),value:"".concat(l),pt:{root:a.getTabPT(c,"root",l)},disabled:a.getTabProp(c,"disabled")},{default:p(function(){return[k(A,{class:f(a.getTabProp(c,"headerClass")),pt:a.getHeaderPT(c,l)},{toggleicon:p(function(m){return[m.active?(i(),s(u(e.$slots.collapseicon?e.$slots.collapseicon:e.collapseIcon?"span":"ChevronDownIcon"),r({key:0,class:[e.collapseIcon,m.class],"aria-hidden":"true",ref_for:!0},a.getTabPT(c,"headericon",l)),null,16,["class"])):(i(),s(u(e.$slots.expandicon?e.$slots.expandicon:e.expandIcon?"span":"ChevronUpIcon"),r({key:1,class:[e.expandIcon,m.class],"aria-hidden":"true",ref_for:!0},a.getTabPT(c,"headericon",l)),null,16,["class"]))]}),default:p(function(){return[c.children&&c.children.headericon?(i(),s(u(c.children.headericon),{key:0,isTabActive:a.isItemActive("".concat(l)),active:a.isItemActive("".concat(l)),index:l},null,8,["isTabActive","active","index"])):v("",!0),c.props&&c.props.header?(i(),y("span",r({key:1,ref_for:!0},a.getTabPT(c,"headertitle",l)),V(c.props.header),17)):v("",!0),c.children&&c.children.header?(i(),s(u(c.children.header),{key:2})):v("",!0)]}),_:2},1032,["class","pt"]),k(S,{pt:a.getContentPT(c,l)},{default:p(function(){return[(i(),s(u(c)))]}),_:2},1032,["pt"])]}),_:2},1032,["value","pt","disabled"])}),128)):h(e.$slots,"default",{key:1})],16)}re.render=ie;export{K as a,w as b,x as c,re as s};
